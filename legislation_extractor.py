...
def main():
    ...
    cookies = {
        "ui-tabs-144": "0",
        "ui-tabs-236": "0",
        "JSESSIONID": "EDC8B34FF373ACF0B7C72C2FC336D5A7"
    }
    
    # Define paths - Update these as needed for your specific legislation folder
    json_file_path = "data/json/legislation_Y.json"
    html_folder = "data/html/legislation_Y"
    data_folder = "data/legislations/legislation_Y"
